...
const CardEffect: React.FC<Props> = ({ order, value }) => {
    ...
    const [drawNum, setDrawNum] = useState(Number(process.env.NEXT_PUBLIC_RANK_CARD_DRAWTWO));
    ...
    return (
        <div className={styles.wrap}>
            ...
            { showAvoidBtn && <div className={styles.avoidBtn}><span>AvoidEffect</span></div> }
        </div>
    )
}
